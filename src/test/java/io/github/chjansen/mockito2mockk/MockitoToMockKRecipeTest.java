...
class MockitoToMockKRecipeTest implements RewriteTest {
    ...
    void convertStaticMockImport() {
        rewriteRun(
            ...
            java(
                """
                package io.mockk;
                public class MockKKt {
                    public static <T> T mockk(Class<T> clazz) { return null; }
                }
                """
            ),
            java(
                ...
                """,
                """
                import static io.mockk.MockKKt.mockk;
    ...
    @Test
    void convertMockitoWildcardImport() {
        rewriteRun(
            java(
                """
                package org.mockito;
    ...
    @Test
    void removeRunWithMockitoJUnitRunner() {
        rewriteRun(
            java(
                """
